...
{: .dica }
Municípios que realizaram ou pretendem realizar a alteração do domínio de acesso da Instalação do PEC e-SUS APS devem obrigatoriamente executar integralmente a Etapa 2 deste tutorial, a fim de obter novas credenciais compatíveis com o novo domínio.
...
> Observação: marque a opção ”Responsável Negocial” se o processo está sendo realizado por um agente público municipal que não seja o Responsável Técnico pela habilitação ou marque a opção “Responsável Técnico” se o processo está sendo realizado pela Referência Técnica responsável pela habilitação.
...
10º Passo: aceite os termos e clique em “Enviar solicitação”, aguardando o prazo de até 10 dias úteis para retorno deste primeiro formulário, onde seu processo ficará com o status “(3) Análise/Aprovação”: 

![alt text](media/gov12.png)
![alt text](media/gov121.png)
...
13º Passo: faça login com a mesma conta GOV.BR que o processo foi iniciado;

14º Passo: se houve alteração do status “(3) Análise/Aprovação” para outro, conforme imagem abaixo, clique em “Responder” para dar andamento no processo. Caso o status não se alterou, favor aguardar e continuar verificando dentro dos 10 dias úteis: 

![alt text](media/gov15.png)

15º Passo: desça a página e procure pela sessão “Análise do Produto Homologação”:

![alt text](media/gov16.png)

16º Passo: em "considerações", copie o “client_id” e “secret” informados: 

![alt text](media/gov17.png)

17º Passo: no servidor da sua Instalação do e-SUS APS, vá no diretório indicado e edite o arquivo “application.properties”: 

- Servidor WINDOWS: C:\Program Files\e-SUS\webserver\config\

- Servidor LINUX: /opt/e-SUS/webserver/config/ 

18º Passo: adicione as seguintes linhas ao fim do arquivo e salve as alterações: 
...
> Observação: substituir onde há “SEU-CLIENT_ID” e “SEU-SECRET” pelas informações obtidas no 16º Passo. 

Exemplo:

![alt text](media/gov18.png)

19º Passo: reinicie o serviço da aplicação do e-SUS APS no servidor: 
...
20º Passo: após reinicialização do serviço, abra sua Instalação do e-SUS APS em um navegador para observar que o botão do login GOV.BR já estará disponível:

![alt text](media/gov19.png) 

21º Passo: volte ao formulário de solicitação do login GOV.BR e procure pelos seguintes campos: 
...
- No campo "Favor adicionar vídeo que demonstre a integração", anexe um vídeo que demonstre a integração do login GOV.BR à sua Instalação do e-SUS APS seguindo as seguintes instruções:
```
...
22º Passo: procure a sessão “Produto(s) de Identidade Digital de interesse” e digite em “Nome do Sistema (Produção): e-SUS APS, conforme imagem abaixo: 

![alt text](media/gov22.png)

23º Passo: vá ao fim do formulário em “Enviar dados/Dúvidas” e selecione a opção abaixo: 

![alt text](media/gov23.png)

24º Passo: clique em “Enviar dados de produção” e a integração do login GOV.BR ao e-SUS APS foi concluída com sucesso!:
...
5ª versão. Atualizado em 23 de maio de 2025.