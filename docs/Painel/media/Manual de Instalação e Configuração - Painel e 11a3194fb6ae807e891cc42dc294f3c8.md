# Manual de Instalação e Configuração - Painel e-SUS APS - MS

**Atualizado em: 20 de novembro de 2024**
**Por: Adriano Neves**
...
Primeira entrega - outubro 224 terá......

![Figura 1 - Versionamento e a data de atualização do Painel e-SUS APS.](b2690153-37f0-4dae-9396-21742c5c2cc4.png)
...
![Figura 2 - Organização e navegação do Painel e-SUS APS.](figura2.0-pagina-inicial.png)
...
Para a instalação do Painel e-SUS APS é necessário avaliar a o tamanho base de dados que será processada pelo Painel e-SUS APS, o que deve influenciar na necessidade de memória RAM e do uso de processamento do servidor. Portanto, abaixo seguem alguns exemplos de configurações, sugerindo o mínimo/recomendado:

A ser avaliado após o teste de processamento do bancos
...
![Figura 3 - Controle de Conta de Usuário.](figura3-controle-conta-usuario.png)
...
![Figura 4 - Local de destino.](figura4-local-destino.png)
...
![Figura 5 – Atalho na área de trabalho.](image.png)
...
![Figura 6 - Pronto para instalar.](figura6-pronto-instalar.png)
...
![Figura 7 - Execução da instalação.](image%201.png)
...
![Figura 8 - Conclusão da instalação.](figura8-conclusao-instalacao.png)
...
![Figura 9 - Arquivo de configuração.](figura09-arquivo-configuracao.png)
...
![Figura 10 - Configuração do banco de dados.](figura10-configuracao-banco-dados.png)
...
![Figura 11 - Diretório do arquivo “credenciais” PEC e-SUS APS.](figura11-diretorio-credenciais-pec.png)

Figura 11 - Diretório do arquivo “credenciais” PEC e-SUS APS.

![Figura 12 - Arquivo .txt “credenciais” PEC e-SUS APS.](figura12-credenciais-pec.png)
...
![Figura 13 - Configurações padrão do PEC e-SUS APS.](figura13-configuracao-pec-painel.png)
...
![Figura 14 - Conexão estabelecida.](figura14-conexao-estabelecida.png)
...
![Figura 15 - Configuração do painel.](figura15-configuracao-painel.png)
...
![Figura 16 - Configuração realizada com sucesso.](figura16-configutacao-sucesso-painel.png)
...
![Figura 17 - Ícone do Painel.](figura17-icone-painel.png)

Figura 17 - Ícone do Painel.

Ao executar a aplicação, um terminal será automaticamente aberto, como apresentado na **Figura 18**.

![Figura 18 - Início do carregamento do Painel.](figura18-carregamento-painel.png)
...
![Figura19: Permissão Firewall Windows.](Captura_de_tela_2024-02-14_143514.png)

Figura19: Permissão Firewall Windows.
...
![Figura 20 - Finalização do carregamento do Painel.](figura19-finalizacao-carregamento-painel.png)
...
![Figura 21 – Tela de acesso ao Painel e-SUS APS](figura20-tela-inicial-painel.png)
...
![WhatsApp Image 2024-11-11 at 12.02.06.jpeg](WhatsApp_Image_2024-11-11_at_12.02.06.jpeg)

### **4.2.1 Instalação do Painel e-SUS APS**

O primeiro passo para instalar o **Painel** no ambiente Linux ****é realizar o download da versão mais atualizada do sistema. Diferentemente da versão windows do **Painel e-SUS**, a versão Linux do sistema é instalada através do arquivo **.tar.gz,** disponível para download no link abaixo: 
...
![**Figura 22:** Pasta Downloads com versão Linux do Painel e-SUS.](1.png)
...
![Figura 23: Painel e-SUS descompactado.](3.png)
...
![**Figura 24**: Pasta descompactada do **Painel e-SUS**.](4.png)
...
![**Figura 25:** Execução da interface de configuração. ](5.png)
...
![**Figura 26:** interface de configuração das variáveis de ambiente do Painel e-SUS.](6.png)
...
![Figura 27 - Configurações padrão do PEC e-SUS APS.](figura13-configuracao-pec-painel.png)
...
Uma vez confirmada a conexão, seguir para aba "Painel e-SUS" e preencher todos os campos, como demonstra a **Figura 28**. Considerar os exemplos a seguir para o preenchimento dos campos:
...
![Figura 28 - Configuração do painel.](figura15-configuracao-painel.png)

Figura 28 - Configuração do painel.

Após completar o preenchimento desta aba, clicar no botão "Finalizar Configuração". Com a finalização dessas etapas, o Painel estará devidamente configurado e pronto para inicialização (**Figura 29**).

![Figura 29 - Configuração realizada com sucesso.](figura16-configutacao-sucesso-painel.png)

Figura 29 - Configuração realizada com sucesso.

### **4.2.3 Inicialização do Painel em ambiente Linux**

Com as variáveis de ambiente devidamente configuradas, para iniciar o sistema, basta abrir um terminal dentro do diretório onde o **Painel e-SUS** foi descompactado e executar o comando “./painel-esus” assim como ilustrado na **Figura 30.**

![**Figura 30:** Comando para execução do Painel e-SUS em ambiente Linux.](9.png)

**Figura 30:** Comando para execução do Painel e-SUS em ambiente Linux.

Ao executar o comando especificado, o Painel e-SUS começará a ser executado automaticamente, apresentando um conjunto de logs no terminal, assim como apresentado na **Figura 31**.

![**Figura 31:** Logs de execução do Painel e-SUS.](10.png)

**Figura 31:** Logs de execução do Painel e-SUS.
...
Quando o sistema estiver pronto para acesso, será apresentado um log assim como o da Figura 32, especificando que o Painel está pronto rodando na porta 5001.

![**Figura 32:** Fim da inicialização do Painel e-SUS em ambiente Linux.](12.png)

**Figura 32:** Fim da inicialização do Painel e-SUS em ambiente Linux.
...
Ao abrir a aplicação, terá o direcionamento para a tela de login. No campo **Login**, inserir o CPF do usuário e no campo **Senha**, digitar a senha correspondente. O acesso do administrador do Painel é configurado durante a instalação inicial, enquanto os profissionais de saúde utilizarão as mesmas credenciais (login e senha) do PEC e-SUS APS. Após preencher os campos, clicar no botão **Entrar** para iniciar a navegação no Painel, como ilustra a **Figura 33**.

![Figura 33 – Tela de acesso ao Painel e-SUS APS](figura20-tela-inicial-painel.png)

Figura 33 – Tela de acesso ao Painel e-SUS APS
...
Neste caso, como a configuração de ambiente já foi realizada anteriormente, ao clicar sobre o executável “config”, uma nova tela irá se abrir, assim como a apresentada na **Figura 22**.

![Figura 22: Reconfigurar variáveis de ambiente](image%202.png)

Figura 22: Reconfigurar variáveis de ambiente
...
A desinstalação do painel-esus pode pode ser executada de duas formas. A primeira delas é clicando duas vezes sobre o executável “unins000.exe” assim como apresentado na **Figura 22**.

![Figura22: Arquivo para desinstalar do Painel e-SUS APS.](Untitled.png)

Figura22: Arquivo para desinstalar do Painel e-SUS APS.
...
![**Figura18:** Mensagem de confirmação para desinstalação software.](Untitled%201.png)

**Figura18:** Mensagem de confirmação para desinstalação software.
