...
#2. ACS - Agente comunitário de saúde
...
| ------/------/Resumo de produção |
| ------/------/Síndrome neurológica por Zika ou Microcefalia |
| ------/------/Vacinação |
| ------/------/Visita domiciliar |
| ------/Operacional |
| ------/------/Cadastro |
...
| ------/Redefinir senha |
| ------/Visualizar acessos |
| ------/------/Cadastrar, editar e excluir acesso |
| ------/------/Cadastrar, editar e excluir lotações |
| Visualizar perfis |
| ------/Cadastrar, editar e excluir |
| Visualizar unidades de saúde |
| Visualizar CBO |
| Configuração municipal |
| ------/Cadastrar, editar e excluir grupos de exames |
| ------/Configurar agenda padrão |
| ------/Cadastrar, editar e excluir tipo de serviço |
| Importar cadastros de cidadão |
| Importar CNES |
| Transmissão de dados |
| ------/Visualizar envio de dados |
| ------/Visualizar recebimento de dados |

#4. ASB - Auxiliar em saúde bucal
...
#5. Auxiliar ou técnico de enfermagem

| Recursos |
| -------- |
| Acompanhamento de condições de saúde |
| ------/Problemas e condições |
| Cadastrar lotes de imunobiológico |
| Visualizar agenda |
| CDS |
| ------/Ficha de cadastro domiciliar
| ------/Ficha de cadastro individual
...
| Visualizar lista de atendimento |
| ------/Cadastrar, editar e excluir |
| ------/Informar que cidadão não aguardou |
| ------/Gerar declaração de comparecimento |
| ------/Atender |
| ------/Realizar atendimento de vacinação |
...
#6. Auxiliar ou técnico de enfermagem AD

| Recursos |
| -------- |
| Atenção domiciliar |
| ------/Visualizar lista de AD da equipe |
| ------/------/Cadastrar |
| ------/------/Editar |
| ------/------/Excluir |
| ------/Visualizar agenda de AD da equipe |
| ------/------/Marcar agendamento |
| ------/------/Excluir |
| ------/Gerar relatório de AD da equipe |
| CDS |
...
| ------/Problemas e condições |
| Visualizar agenda |
| ------/Adicionar cidadão na fila de atendimento |
| ------/Marcar agendamento |
| ------/Excluir |
...
| ------/------/Editar antecedentes |
| ------/Visualizar histórico de atendimento |
| ------/Visualizar lista de problemas e condições |
| ------/------/Cadastrar, editar e excluir |
| ------/SOAP |
| ------/------/Subjetivo |
| ------/------/Avaliação |
...
| ------/------/------/------/Cadastrar, editar e excluir |
| ------/------/------/------/Imprimir |
| ------/------/------/Visualizar encaminhamento externo |
| ------/------/------/------/Cadastrar, editar e excluir |
| ------/------/------/------/Imprimir |
| ------/------/------/Visualizar exames |
| ------/------/------/------/Cadastrar, editar e excluir |
...
| ------/Redefinir senha |
| ------/Visualizar acessos |
| ------/------/Cadastrar, editar e excluir lotação |
| ------/-----/Configurar agenda |
| ------/------/Configurar agenda online |
| ------/------/Fechar agenda |
| Visualizar unidades de saúde |
| ------/Ativar ou inativar tipo de serviço |
| ------/Configurar consulta no Hórus |
| Visualizar agenda |
| ------/Adicionar cidadão na fila de atendimento |
| ------/Marcar agendamento |
| ------/Excluir |
...
|  Atenção Domiciliar |
| ------/Visualizar lista de AD da equipe |
| ------/------/Visualizar lista de AD do município |
| ------/------/------/Editar |
| ------/------/------/Excluir |
| ------/Visualizar agenda de AD da equipe |
| ------/------/Visualizar agenda de AD do município
| ------/------/------/Marcar agendamento |
| ------/------/------/Excluir |
| ------/Gerar relatório de AD da equipe |
| ------/------/Gerar relatório de AD do município |
| Gestão de cadastros de cidadão |
| ------/Visualizar cidadão |
| ------/------/Cadastrar e editar |
| ------/------/Excluir |
...
| ------/Ficha de consumo alimentar |
| ------/------/Cadastrar, editar e excluir |
| ------/Ficha complementar - Síndrome neurológica por Zika ou Microcefalia |
| ------/------/Cadastrar, editar e excluir |
| ------/Ficha de vacinação |
| ------/------/Cadastrar, editar e excluir |
...
| ------/Configurar conexão com Internet |
| ------/Configurar conexão com CADSUS |
| ------/Configurar conexão com Hórus |
| ------/Configurar Agenda online |
| ------/Configurar conexão com Segurança |
| ------/Configurar integração com sistema VIO |
| ------/Configurar conexão com número de requisições simultâneas |
| ------/Listar municípios e responsáveis |
| Relatórios |
| ------/Processar relatórios |
| Importar CNES |
| Transmissão de dados |
| ------/Configurar instalações de envio |
...
#20. Outro prof. de nível superior
...
#21. Outro prof. nível superior AD
...
#22. Outro prof. nível médio técnico
...
#23. Outro prof. nível médio técnico AD
...
---
layout: doc
title: Perfis padrão do PEC 
id: RF-PER.recursos_perfil
order: 1
parent: RF-PER.recursos
---
